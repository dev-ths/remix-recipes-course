...
//pattern: parent component exports function wrapping the context while providing the type information for that context
	...
	return (
		<>
			...
			>
				...
				<div className="my-4 grid grid-cols-[30%_auto_min-content] gap-2">
					<h2 className="pb-1 text-sm font-bold">Amount</h2>
					<h2 className="pb-1 text-sm font-bold">Name</h2>
					<div></div>
				...
				<label
					...
					className="block w-fit pb-2 text-sm font-bold"
				>
					Instructions
				</label>
				<textarea
					...
					className={classNames(
						"h-56 w-full rounded-md outline-none",
						"duration-300 focus:border-2 focus:border-primary focus:p-3",
				...
				<label
					htmlFor="image"
					className="mt-4 block w-fit pb-2 text-sm font-bold"
				>
					Image
				</label>
				<input
				...
				<div className="flex justify-between">
					...
					<PrimaryButton
						...
						value="saveRecipe"
					>
						<div className="flex h-full flex-col justify-center">Save</div>
					</PrimaryButton>
				</div>
			</Form>
		</>
